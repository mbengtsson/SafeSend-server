...
public interface FloodService {
	 ...
	 * @param identifier the flood events identifier, usually an IP address.
	 */
	 ...
	 * @param eventType  the flood event type.
	 * @param identifier the flood events identifier, usually an IP address.
	 * @param expiration the expiration time when the flood event is considered expired
	 ...
	 * @param eventType  the flood event type.
	 * @param identifier the flood events identifier.
	 * @param threshold  the maximum number of times each identifier can do this event.
